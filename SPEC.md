...
- **格式标准化难**：会议级别的综述（如 CVPR 格式）有严格的排版和引用规范
...
| ID | 角色 | 故事 | 验收标准 |
|----|------|------|---------|
| US-1 | 研究人员 | 我可以输入一个研究主题，启动 agent 自动生成一篇 CVPR 格式的综述论文 | 系统在 30 分钟内输出包含摘要、引言、分类、方法对比、挑战与未来工作的完整综述 |
