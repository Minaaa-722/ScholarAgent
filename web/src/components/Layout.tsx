...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div style={{ display: "flex", height: "100vh", overflow: "hidden", fontFamily: "var(--font-family)" }}>
      <nav style={{ width: 220, background: "var(--color-bg-dark)", color: "#fff", padding: "var(--space-md)", overflowY: "auto", flexShrink: 0 }}>
      ...
      <main style={{ flex: 1, padding: "var(--space-xl)", background: "var(--color-bg)", overflowY: "auto", minHeight: 0 }}>{children}</main>
    </div>
  );
}